        ...
        if (holding['inventory_type'] == 'physical') {
            ...
            if (holding['activation_status'] == 'Available') {
                ...
                if (holding['portfolio_pid']) {
                    url = "https://upenn.alma.exlibrisgroup.com/view/uresolver/01UPENN_INST/openurl?Force_direct=true&portfolio_pid=" +
...
},{"ezproxy-login-status":2}],2:[function(require,module,exports){
...
},{"login-status":3}],3:[function(require,module,exports){
var LOGIN = {};
