...
gem 'blacklight', '6.8.0', git: 'https://gitlab.library.upenn.edu/franklin/blacklight.git', branch: 'v6.8.0-solr7-qq-feedFormat'
...
gem 'summon', git: 'https://gitlab.library.upenn.edu/franklin/summon.rb.git', branch: 'sign-empty-param-values'
