...
class StanfordIndexer < FranklinIndexer
  ...
  def link_to_source_context(rec)
    ...
    "https://searchworks.stanford.edu/view/#{system_id}"
  end
  ...
  def get_001_id(rec)
    ...
    id.blank? ? nil : id[1..-1] # strip the leading "a" present in Stanford 001
  end
  ...
  def define_full_text_link_a
    to_field 'full_text_link_a' do |rec, acc|
      ...
      links << {
        linktext: 'View record in Stanford\'s catalog',
