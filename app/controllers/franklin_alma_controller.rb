...
# TODO: Uncomment when libraries reopen
  ...
  def request_options
    ...
    results.append({
                     ...
                     :highlightable => true
                   }) if ['Athenaeum Member','Faculty','Faculty Express','Grad Student','Undergraduate Student','Library Staff'].member?(session['user_group']) && !suppress_pickup_at_penn(ctx) # suppress for bbm is same as for Pickup@Penn
