...
#      fq: '{!tag=cluster}{!collapse field=cluster_id nullPolicy=expand size=5000000 min=record_source_id}',
    ...
    add_fields.call(config, 'show', [
        ...
        { dynamic_name: 'provenance_display', label: 'Penn Libraries Provenance', helper_method: 'render_linked_values' },
        { dynamic_name: 'chronology_display', label: 'Penn Libraries Chronology', helper_method: 'render_linked_values' },
